...
try {
    ...
    $logId = $importLog->create('customer_existing', $originalName, $userId);
    ...
    Response::json(array(
        'success' => true,
        'message' => $execute ? 'Import customer existing berhasil diproses.' : 'Preview import customer existing berhasil.',
        'data' => $result,
    ));
